...
class Perfil_Usuario extends Clases{
    ...
    public function reload($datos){
            ...
            $this->nombres              =(isset($datos['nombres'])) ? $datos['nombres'] : $nombres;
            $this->usuario           =(isset($datos['usuario'])) ? $datos['usuario'] : $usuario;
            $this->apellidos         =(isset($datos['apellidos'])) ? $datos['apellidos'] : $apellidos;
            $this->avatar           =(isset($datos['avatar'])) ? $datos['avatar'] : $avatar;
            $this->email   =(isset($datos['email'])) ? $datos['email'] : $email;
