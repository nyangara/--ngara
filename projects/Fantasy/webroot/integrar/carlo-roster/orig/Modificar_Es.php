...
<?php } else { 
    ...
    <div id="content">
        ...
        <div id="contenido_interno">
            <div id="box_info">
                <form id="Alcance" action="Modificar_Es.php" enctype="multipart/form-data" method="post">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><input size="200" name="descripcion" type="text" value="<?php echo $Estadio->descripcion; ?>" /></td>
                        </tr>
                    </table>                    
