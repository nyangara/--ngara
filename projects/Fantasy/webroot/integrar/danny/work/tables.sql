...
CREATE TABLE "Fantasy"."Participa" (
        ...
        CONSTRAINT "Participa UNIQUE liga_manager"
                UNIQUE ("liga", "manager"),
...
CREATE TABLE "Fantasy"."Juego" (
        "id"                        serial                          NOT NULL,
        "status"                    text                            NOT NULL default 'pautado',
        "inicio"                    timestamp with time zone        NOT NULL,
        "equipo_local"              integer                         NOT NULL,
        "equipo_visitante"          integer                         NOT NULL,
        "estadio"                   integer                         NOT NULL,
        "carreras_equipo_local"     integer                             NULL,
        "carreras_equipo_visitante" integer                             NULL,
        "hits_equipo_local"         integer                             NULL,
        "hits_equipo_visitante"     integer                             NULL,
        "errores_equipo_local"      integer                             NULL,
        "errores_equipo_visitante"  integer                             NULL,
