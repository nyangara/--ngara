...
if(isset($_POST['Aplicar'])){
    ...
    if($_FILES['imagen']['error'] == 0){
        ...
        $directorio = 'assets/images/Fotos_Estadios/';
        ...
        $_POST['foto'] = 'assets/images/Fotos_Estadios/generico.jpg';    
...
<?php } else { 
    ...
    <div id="content">
        <div id="contenido_interno_datos">
            <div id="box_info">
                <form id="Alcance" action="Agregar_Es.php" enctype="multipart/form-data" method="post">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><input size="200" name="descripcion" type="text" value="" /></td>
                        </tr>
                    </table>
