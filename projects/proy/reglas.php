...
<!--Menu de Navegación-->
    ...
    <!-- COMO USAR MENU DE NAVEGACION 
        ...
        <ul id="navigation">
          ...
          <li class="on"><a href="reglas.php">Reglas</a></li>
...
EOD;
        ...
        $result = pg_execute($dbconn, "noticia", array('Reglas')) or die('pg_execute: ' . pg_last_error());
        while ($row = pg_fetch_row($result)) {
                echo '<tr><td width="50px"><h3 >' . $row[1] . '</h3><p>' . $row[2] . '</p>';
